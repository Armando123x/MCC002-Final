...
\newcommand{\TituloInforme}{
    Factores asociados al riesgo crediticio y evaluación de umbrales de decisión
}

\newcommand{\SubtituloInforme}{
    Análisis frecuentista, predictivo y bayesiano del Statlog German Credit Data
}
